          ...
          <ScrollMotionEffect effect="fade-left" duration="2000">
            <div className="flex-1">
              ...
              <p className="mb-2 text-center md:text-left">
                {`Attorney Hardam Tripathi is committed to providing top-notch criminal defense and personal injury representation in Milwaukee, Wisconsin. He focuses on criminal law, offering strong defense for clients facing charges like drug offenses, DUI/OWI, domestic violence, theft, assault, and other serious crimes. With a deep understanding of Wisconsin’s criminal code and skilled courtroom advocacy, Tripathi works to protect his client's rights, reduce or dismiss charges, and achieve the best possible outcomes through negotiation or trial.`}
              </p>
              <p className="mb-2 text-center md:text-left">
              ...
              <p className="mb-2 text-center md:text-left">
                {`Before starting his practice, Tripathi worked as a management consultant at a Big Four firm, where he provided risk intelligence and compliance solutions for government and public service clients. This role sharpened his skills in managing complex regulatory systems, which now guide his approach to criminal defense and personal injury cases.`}
              </p>
              <p className="mb-2 text-center md:text-left">
