...
const HeroSection = () => {
  ...
  return (
    <div className="relative mt-[-100px] md:overflow-hidden">
      <div className="relative h-[650px] md:h-[950px]">
        <Image
          ...
          <div className="container ">
            <div className="grid items-center grid-cols-1 md:grid-cols-3 pt-200px">
              <div className="col-span-2 mt-32">
                ...
                >
                  <Link
                    className="flex items-center justify-center px-2 py-3 mb-2 text-sm font-medium text-white rounded-lg bg-primary hover:bg-yellow-400 md:text-lg md:px-8 me-3 md:me-6 w-[180px] md:w-[240px]"
                    href="/appointment"
                  >
                    Free Consultation{" "}
                    <span>
