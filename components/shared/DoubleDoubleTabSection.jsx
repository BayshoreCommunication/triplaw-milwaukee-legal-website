...
export function DoubleDoubleTabSection({ tabsData }) {
  ...
  return (
    <Tabs value='2'>
      ...
      >
        ...
        <TabsHeader
          className={`p-1 rounded-full bg-[#F4F4F4] md:p-1 flex items-center justify-center mt-4 w-[100%] md:w-[33%] mx-auto`}
          indicatorProps={{
