export const servicesData = [
  {
    ...
    />
                    ...
                    <ul className="space-y-1">
                      ...
                      <li className="flex items-start">
                        <span className="w-1.5 h-1.5 me-3 mt-2">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="w-3 h-3 text-black me-2"">
      ...
      <ul className="space-y-1">
        <li className="flex items-start">
          <span className="w-1.5 h-1.5 me-3 mt-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-3 h-3 text-black me-2">
      ...
      <p>
        Choose Trip Law not just because we're good at what we do, but because we're all about making your dream of building a life in the U.S.A with your loved one a reality.
      </p>
  ...
  },
  {
    ...
    <br/>
    <p>
    If you want to chat about your situation and see how we can make your dream of living with your loved ones in the U.S.A happen, let's set up a consultation. We're here to help.
    ...
    <div>
      ...
      <p>
         Are you all set to start the process for getting your permanent residency in the U.S.A, but you're currently living outside the country? Going through Consular Processing for a Green Card can be your ticket to making that dream a reality. It can be a bit tricky to figure out all the ins and outs, but don't worry! We're here to give you expert advice and full support to make sure everything goes smoothly and you can make that transition successfully.
                  ...
                  <p>Feeling overwhelmed by communication with the NVC and foreign government agencies.
                  </p>
              </li>
              ...
              <p>Preparing effectively for the visa interview and overcoming potential anxieties.
              </p>
            </li>
            ...
            <p>Addressing complex legal issues like inadmissibility and seeking waivers.
            </p>
          </li>
            ...
            <p>Feeling isolated and unsure of next steps due to being outside the U.S.A
            </p>
          </li>
        </ul>
        ...
        <br />
        <p>
        We get it—going for a Green Card through Consular Processing can be a bit of a rollercoaster. At Trip Law, we're here to make it easier for you. Expect us to:
        </p>
      </br>
      ...
      <ul className="space-y-1">
        ...
        <li className="flex items-start">
          ...
          <p>
         We'll chat with the National Visa Center so you don't have to. And when it's time for your interview at the U.S.A consulate, we'll get you ready and help you schedule it.
          </p>
        </li>
      ...
      <p>
      Hey, let's talk about your situation. We'll sit down and discuss how Trip Law can assist you in smoothly navigating the process of getting a Green Card through Consular Processing
      </p>
  ...
  },
  {
    ...
    dece: `
          <div>
            ...
            <p>Effectively communicating with USCIS and responding to any requests for evidence.
            </p>
          </li>
      ...
      <ul className="space-y-1">
        ...
        <li className="flex items-start">
          ...
          <p>We'll be the talkative types with USCIS, keeping things smooth throughout.
          </p>
        </li>
    ...
    dece: `
          <div>
                  <img
                    ...
                    <p>
                    Are you a key employee within a multinational company, eager to contribute your valuable skills and experience to the U.S.A branch? The L-1 visa program facilitates the intracompany transfer of executives, managers, and specialized knowledge workers, allowing you to seamlessly transition and continue your impactful work in the United States. Our legal guidance will make sure your journey to getting that L-1 visa is a breeze, so you can hit the ground running in the U.S.A and make a real impact.
                    </p>
              ...
              <p>Establishing a qualifying relationship between the foreign and U.S.A companies.
              </p>
            </li>
            ...
            <p>Effectively communicating with USCIS and responding to requests for evidence.
            </p>
          </li>
        ...
        <br />
        <p>
        We understand the critical role you play within your company and the importance of securing your L-1 visa to seamlessly continue your contribution in the U.S.A We are committed to provide you with:
        </p>
      </br>
      ...
      <ul className="space-y-1">
        ...
        <li className="flex items-start">
          ...
          <p>Proving there's a legit connection between your foreign and U.S.A companies? We got that covered too.
          </p>
        </li>
        ...
        <li className="flex items-start">
          ...
          <p>We'll be the middlemen with USCIS, handling the communication throughout. If there are any red flags, we'll tackle them head-on and explore waivers if needed.
          </p>
        </li>
  ...
  },
  {
    ...
    <p>Effectively communicating the significance of their work and impact on the U.S.A
    </p>
</li>
...
<br />
<p>
We understand the unique journey of individuals with extraordinary abilities and the value they bring to the U.S.A We are committed to providing you with:
</p>
</br>
...
<p>Dealing with USCIS? Leave that to us. If we hit any roadblocks, we'll tackle them straight on and see if waivers are necessary.
</p>
</li>
...
<p>Effectively communicating the significance of their work and lasting contributions to the U.S.A
</p>
</li>
...
<h2>Why choose Trip Law?</h2>

<br />
<p>
Recognizing the distinctive journey of individuals with extraordinary abilities and the transformative impact they can have in the U.S.A, Trip Law is dedicated to offering you:
</p>
</br>
...
<p>Effectively communicating the value they bring to the U.S.A workforce and overcoming potential challenges.
...
<p>
Ready to consult about your EB-2 visa possibilities? Let's set up a meeting and discuss how Trip Law can help you make your way to permanent residency in the U.S.A and start sharing your skills here.
...
<ul className="space-y-1">
  ...
  <li className="flex items-start">
    ...
    <p>We'll keep in touch with USCIS the whole way through, making sure everything's on track. If there are any hiccups, we'll deal with them and look into waivers if needed.
    </p>
  </li>
...
<ul className="space-y-1">
  ...
  <li className="flex items-start">
    ...
    <p>We'll stay in touch with USCIS throughout the whole process, making sure everything's on track. If there are any problems, we'll deal with them and look into waivers if needed.
    </p>
  </li>
...
<ul className="space-y-1">
  ...
  <p>We'll stay in touch with USCIS to make sure everything's going smoothly.
  </p>
</li>
...
<ul className="space-y-1">
  ...
  <li className="flex items-start">
   ...
   <li className="flex items-start">
    ...
    <p> We'll fight tooth and nail for your rights and make sure the judge hears exactly why you deserve the outcome you're seeking.
    </p>
  </li>
...
<ul className="space-y-1">
  ...
  },
  {
    ...
    <p>Effectively demonstrating the substantial nature of their investment and its positive impact on the U.S.A economy.
    </p>
    </li>
...
<ul className="space-y-1">
  ...
  <li className="flex items-start">
    ...
    <p>We'll be the go-between for you and the USCIS, making sure everything's on track and answering any questions they might have.
    </p>
  </li>
  ...
  <p>
  Please arrange a consultation at your earliest convenience to discuss your E-2 Treaty Visa options and learn how Trip Law can help you navigate the legal pathway towards realizing your business aspirations in the U.S.A.
  </p>
...
<p>Preparing for the naturalization interview and civics test to demonstrate your understanding of U.S.A history and government.
</p>
</li>
...
<ul className="space-y-1">
  ...
  <li className="flex items-start">
    ...
    <p>
    We'll act as your intermediary with USCIS, handling all communication and ensuring they have all necessary documents and answering their queries that may arise during the process.
    </p>
  </li>
  ...
  },
  {
    ...
    <img
      ...
      <p>
      Becoming a U.S.A citizen unlocks a multitude of rights and privileges, solidifying your place within the American fabric. Whether you've dreamt of this moment for years or recently arrived seeking a permanent home, the naturalization process can be complex and daunting. We're right there with you, offering top-notch legal advice and steady support to help you reach your citizenship dreams. 
      </p>
...
<ul className="space-y-1">
  ...
  <li className="flex items-start">
    ...
    <p>
      We'll be the middleman between you and the USCIS, making sure they've got everything they need and helping out with any questions they might have.
    </p>
  </li>
  ...
  <p>
  Schedule a consultation today to discuss your naturalization & citizenship options and learn how Trip Law can help you navigate the legal path towards claiming your rightful place as a U.S.A citizen.
  </p>
    ...
    <img
      ...
      <ul className="space-y-1">
        ...
        <li className="flex items-start">
          ...
          <p>
            Family members of U.S.A citizens: Spouses, children, parents, and siblings seeking family-based green cards.
          </p>
        </li>
        ...
        <li className="flex items-start">
          ...
          <p>
            Employment-based immigrants: Professionals offered job opportunities in the U.S.A
          </p>
        </li>
      ...
      <li className="flex items-start">
        ...
        <p>       
          Refugees and asylum seekers: Fleeing persecution and seeking safe haven in the U.S.A
        </p>
      </li>
      ...
      <p>
       Refugees and asylum seekers: Fleeing persecution and seeking safe haven in the U.S.A
        ...
        <li className="flex items-start">
          ...
          <p>
            Investors: Entrepreneurs establishing businesses and creating jobs in the U.S.A
...
<ul className="space-y-1">
  ...
  <li className="flex items-start">
    ...
    <p>
      We'll handle all the back-and-forth with the USCIS, making sure they've got everything they need and keeping you in the loop every step of the way.
    </p>
  </li>
