  ...
  return (
    <>
      ...
      <section className="container font-roboto text-base py-10 md:py-20 flex justify-center gap-4 items-start flex-col">
        ...
        <div>{`This acceptable use policy covers the products, services, and technologies (collectively referred to as the “Products”) provided by Carter Injury Law, PA under any ongoing agreement. It’s designed to protect us, our customers, and the general Internet community from unethical, irresponsible, and illegal activity. Carter Injury Law, PA customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities. This policy was last reviewed on 31 October 2022.`}</div>
        <div>
        ...
        <div>
          <span className="font-bold">
            Unauthorized use of Carter Injury Law, PA property:
          </span>
          {` We prohibit the impersonation of Carter Injury Law, PA, the representation of a significant business relationship with Carter Injury Law, PA, or ownership of any Carter Injury Law, PA property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage, or user trust.`}
        </div>
        <div>
